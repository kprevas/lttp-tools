...
def raze_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:aho-corasick-0.7.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:autocfg-0.1.4.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:deflate-0.7.19.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:env_logger-0.6.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:inflate-0.4.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:libc-0.2.58.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:num-iter-0.1.39.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:png-0.14.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:prefix-tree-0.1.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:regex-1.1.7.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:regex-syntax-0.6.7.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:simple-error-0.2.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:termion-1.5.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:utf8-ranges-1.0.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//cargo/remote:wincolor-1.0.1.BUILD")
    )
